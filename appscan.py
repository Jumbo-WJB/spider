...
class Appscan(object):
    ...
    def Browser(self):
        c1 = {'name': u'Hm_lvt_2d9a49e839e5ceb193269aefa897ae80','value': u'1494907879,1494929755,1494937440,1495442440'}
        c2 = {'name': u'Hm_lpvt_2d9a49e839e5ceb193269aefa897ae80','value': u'1495442477'}
        c3 = {'name': u'PGSessionId','value': u'339e4901-e526-48b5-aa34-80ac203681f8'}
...
work = Appscan("http://appscan.io/app-report.html?id=yourid")
work.Browser()
work.Result()
